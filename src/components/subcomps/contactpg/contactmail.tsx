...
const Contactmail = (props: Props) => {
  return (
    <form className="flex w-72 md:w-full max-w-sm space-x-3 ">
      <div className="w-full max-w-2xl px-5 py-10 m-auto mt-10 bg-black bg-opacity-80 rounded-lg shadow ">
        ...
        <div className="grid max-w-xl grid-cols-2 gap-4 m-auto">
          ...
          <div className="col-span-2 text-right">
            <button
              type="submit"
              className="py-2 px-4  bg-indigo-800 hover:bg-indigo-900 focus:ring-indigo -500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
            >
              Send
            </button>
          </div>
